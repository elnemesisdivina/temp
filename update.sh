...
if [ -z "$git_email" ]
then
  echo Git user.email unset.  Setting to \"elnemesisdivina@gmail.com\"
  git config user.email "elnemesisdivina@gmail.com"
fi
if [ -z "$git_name" ]
then
  echo Git user.name unset.  Setting to \"elnemesisdivina\"
  git config user.name "elnemesisdivina"
fi
echo
